...
export default function SignUp() {
  ...
  // Social sign-ins removed by request; email-only signup retained.
      ...
      <Card className="w-full max-w-md">
        <div className="space-y-6">
          <div className="text-center">
            ...
            <p className="text-slate-600">Join EcoSkill and start earning while learning.</p>
          </div>
          {/* Email-only sign up */}
          ...
          <p className="text-center text-sm text-slate-600">
            Already have an account? <Link to="/login" className="text-emerald-700 hover:text-emerald-900">Log in</Link>
          </p>
        </div>
      </Card>
    </div>
